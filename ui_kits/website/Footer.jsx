    ...
    <footer style={ft.wrap}>
      <div style={{...ft.inner, ...(isMobile ? ft.innerMobile : {})}}>
        ...
        <Col title="Calculators" items={[
          ...
          {label:"Borrowing Power",id:"calc-borrowing-power"},{label:"Maximum Purchase Price",id:"calc-max-purchase-price"},{label:"Funding Position",id:"calc-funding-position"},{label:"Equity Calculator",id:"equity-calculator"},{label:"Loan Repayment",id:"calc-loan-repayment"},
          {label:"Stamp Duty Calculator",id:"stamp-duty-calculator"},{label:"Saving Calculator",id:"calc-savings"},
          {label:"Extra & Lump Sum Repayments",id:"calc-extra-repayment"},
