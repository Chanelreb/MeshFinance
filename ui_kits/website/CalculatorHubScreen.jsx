...
const calcHubS = {
  ...
  cardTitle: { fontFamily:"var(--font-display)", fontSize:18, lineHeight:1.25, color:"var(--navy-700)", margin:"0 0 5px", fontWeight:700,
    minHeight:45, display:"flex", flexDirection:"column", justifyContent:"flex-end" },
  cardName: { fontSize:12.5, lineHeight:1.3, color:"var(--color-primary)", fontWeight:600, margin:"0 0 12px", textTransform:"uppercase", letterSpacing:".03em",
    minHeight:32, display:"flex", flexDirection:"column", justifyContent:"flex-end" },
