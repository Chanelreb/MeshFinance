...
window.MeshContent = {
  ...
  calculatorHub: {
    ...
    items: [
      ...
      { emoji: "🔑", title: "What's My Ceiling?", name: "Maximum Home Purchase Price Calculator", id: "calc-max-purchase-price", body: "Estimate the most you may be able to spend on a WA home to live in, factoring in your deposit, borrowing power, stamp duty, government deposit schemes and the First Home Owner Grant." },
